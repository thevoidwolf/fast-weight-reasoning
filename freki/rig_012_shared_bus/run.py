...
from model import SharedBusConfig, build_model
...
def train_one_shared_bus(
    ...
    payload = {
        "tag": tag, "rig": "rig012_shared_bus", "seed": seed,
...
def main():
    ...
    ap.add_argument("--tag-prefix", default="rig012_sharedbus_ent512_d64")
