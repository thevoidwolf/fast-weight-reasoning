...
from tasks_id import sample_long_3hop_identity_mode, sample_long_4hop_identity_mode
    ...
    for step in range(cfg.steps):
        ...
        with torch.autocast(device_type=cfg.device, dtype=torch.bfloat16,
            ...
            if apply_aux:
                ...
                # K_chain=K has K-1 cleanup hops; supply bridges 1..K-1 as targets.
                if cfg.hops == 4:
...
def main():
    ...
    ap.add_argument("--tag-prefix", default="rig013_delta_ent512_d64")
